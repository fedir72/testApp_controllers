...
public struct Helpers {
   ...
   static let roundValue: CGFloat = 8
    ...
    static func getController(identifier: String ,goTo contr: UIViewController,transitStyle: UIModalTransitionStyle? ,presentStyle: UIModalPresentationStyle = .automatic) -> UIViewController {
